...
namespace Question1.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,ProductName,Price,UPCCode")] Product product)
        {
...
{
	List<IObserver<Product>> observers;
   ...
   public IDisposable Subscribe(IObserver<Product> observer)
   {
      ...
      return new Unsubscriber(observers, observer);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,ProductName,Price,UPCCode")] Product product)
        {
            if (id != product.ID)
            {
                return NotFound();
